...
@implementation ZooMethodUseTimeManager
...
- (void)setOn:(BOOL)on{
    [[ZooCacheManager sharedInstance] saveMethodUseTimeSwitch:on];
}

- (BOOL)on{
    return [[ZooCacheManager sharedInstance] methodUseTimeSwitch];
}

...
@interface ZooMCXPathNode : NSObject
...
@property (nonatomic , strong , readonly) NSArray<ZooMCXPathNode *> *listContainerPathNodeList;

/// 如果isOneCell为true , 这个字段有值 代表当前控件所在cell在列表容器中的索引
@property (nonatomic , strong  ) NSIndexPath *cellIndexPath;

/// 从根window到当前控件的XPath 如果isOneCell为true , 就代表从listContainer到当前控件的XPath
@property (nonatomic , copy  , readonly) NSArray<ZooMCXPathNode *> *pathNodeList;

...
@interface ZooMCServer ()
@property (nonatomic , strong) HTTPServer *server;
@end

@implementation ZooMCServer

+ (instancetype)shareInstance {
   static  ZooMCServer *instance = nil;
...
- (void)close {
    if (self.server) {
        ...
        [ZooToastUtil showToastBlack:@"服务已关闭" inView:currentWindow];
    }
}
...
- (void)didOpen {
    [super didOpen];
    NSLog(@"didOpen");
    [[NSNotificationCenter defaultCenter] postNotificationName:@"com.didi.DoraemonMCServer.wsDidConnect" object:nil userInfo:@{@"count":@([ZooMCServer connectCount])}];
}

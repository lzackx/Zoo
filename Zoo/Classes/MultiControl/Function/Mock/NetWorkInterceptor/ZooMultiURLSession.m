...
@interface ZooMultiURLSession () <NSURLSessionDataDelegate>
...
@implementation ZooMultiURLSession
...
- (instancetype)initWithConfiguration:(nullable NSURLSessionConfiguration *)configuration {
    ...
    if(self != nil) {
        ...
        [self.seesionDelegateQueue setName:NSStringFromClass([ZooMultiURLSession class])];
        [self.seesionDelegateQueue setMaxConcurrentOperationCount:1];
        self.seesion.sessionDescription = NSStringFromClass([ZooMultiURLSession class]);

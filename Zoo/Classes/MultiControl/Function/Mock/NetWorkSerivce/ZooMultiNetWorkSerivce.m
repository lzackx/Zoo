...
@implementation ZooMultiNetWorkSerivce
...
+ (void)startRecordRequestWithSus:(void(^)(id responseObject))sus
    ...
    [param setValue:[ZooUtil currentTimeInterval] forKey:@"time"];
    [param setValue:[ZooAppInfoUtil iphoneType] forKey:@"phoneModel"];
    [param setValue:[ZooAppInfoUtil iphoneSystemVersion] forKey:@"systemVersion"];
    [param setValue:[ZooAppInfoUtil appName] forKey:@"appName"];

...
- (void)doraemonNetworkInterceptorDidReceiveData:(NSData *)data
    ...
    [ZooMultiNetWorkSerivce uploadApiInfoWithItem:item sus:^(id  _Nonnull responseObject) {
                                         ...
                                         fail:(void(^)(NSError *error))fail
{
    ...
    [ZooMultiNetWorkSerivce getCaseApiInfoWithCaseID:[DoraemMultiMockManger sharedInstance].selectCaseId key: key  sus:^(id  _Nonnull responseObject) {
...
- (DoraemMultiItem *)getDoraemMultiItemWithData:(NSData *)data
    ...
    //发送请求的body
    NSDictionary *requestBody = [ZooUrlUtil convertDicFromData:body];

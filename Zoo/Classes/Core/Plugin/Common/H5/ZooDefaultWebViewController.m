...
@interface ZooDefaultWebViewController ()
...
@implementation ZooDefaultWebViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = ZooLocalizedString(@"Zoo内置浏览器");
...
- (UIProgressView *)progressView {
    if (!_progressView) {
        _progressView = [[UIProgressView alloc] initWithFrame:CGRectMake(0.0, IPHONE_NAVIGATIONBAR_HEIGHT, ZooScreenWidth, 1.0)];
        _progressView.tintColor = [UIColor zoo_blue];      // 进度条颜色

...
@interface ZooMockManager : NSObject

+ (instancetype)sharedInstance;

@property (nonatomic, assign) BOOL mock;
@property (nonatomic, strong) NSMutableArray<ZooMockAPIModel *> *mockArray;
@property (nonatomic, strong) NSMutableArray<ZooMockUpLoadModel *> *upLoadArray;

...
@interface ZooVisualInfoViewController : UIViewController
@property (nonatomic, strong) UIButton *closeBtn;
@property (nonatomic, strong) UILabel *infoLabel;
@end

@implementation ZooVisualInfoViewController
...
- (void)initUI {
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        self.closeBtn = [[UIButton alloc] initWithFrame:CGRectMake(viewSize.width - closeWidth - kZooSizeFrom750_Landscape(16), kZooSizeFrom750_Landscape(16), closeWidth, closeHeight)];
        ...
        self.infoLabel = [[UILabel alloc] initWithFrame:CGRectMake(kZooSizeFrom750_Landscape(32), 0, viewSize.width - kZooSizeFrom750_Landscape(32 + 16) - closeWidth , viewSize.height)];
        self.infoLabel.backgroundColor = [UIColor clearColor];
        self.infoLabel.textColor = [UIColor zoo_black_1];
        self.infoLabel.font = [UIFont systemFontOfSize:kZooSizeFrom750_Landscape(24)];
...
- (void)viewWillTransitionToSize:(CGSize)size withTransitionCoordinator:(id<UIViewControllerTransitionCoordinator>)coordinator {
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        self.view.window.frame = CGRectMake(kZooSizeFrom750_Landscape(30), ZooScreenHeight - self.infoLabel.frame.size.height - kZooSizeFrom750_Landscape(30), size.height, size.width);
    });
}

@end

@interface ZooVisualInfoWindow ()
@property (nonatomic, weak) UILabel *infoLabel;
@end

@implementation ZooVisualInfoWindow
...
- (void)commonInit {
    ...
    self.rootViewController = [[ZooVisualInfoViewController alloc] init];

...
@interface ZooStartTimeViewController ()<ZooSwitchViewDelegate,ZooCellButtonDelegate>
...
@implementation ZooStartTimeViewController
...
- (BOOL)zoo_application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions{
    ...
    [ZooHealthManager sharedInstance].startTime = (endTime-startTime)*1000;
    return ret;
}
